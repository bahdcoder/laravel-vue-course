      ...
      <section class="section bg-gray">
        <div class="container">
          ...
          <div class="row gap-y">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card card-hover-shadow">
                <a href="blog-single.html"><img class="card-img-top" src="assets/img/blog-4.jpg" alt="Card image cap"></a>
                <div class="card-block">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card card-hover-shadow">
                <a href="blog-single.html"><img class="card-img-top" src="assets/img/blog-5.jpg" alt="Card image cap"></a>
                <div class="card-block">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card card-hover-shadow">
                <a href="blog-single.html"><img class="card-img-top" src="assets/img/blog-6.jpg" alt="Card image cap"></a>
                <div class="card-block">
